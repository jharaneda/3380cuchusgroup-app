...
export async function getTenantList() {
  // return fetch("http://34.207.211.81:8000/tenants").then((response) =>
  return fetch("http://localhost:8000/tenants").then((response) =>
    response.json()
  );
}
export async function getHealthReport() {
  // return fetch("http://34.207.211.81:8000/health/report").then((response) =>
...
export async function getIncidentReport() {
  // return fetch("http://34.207.211.81:8000/incident").then((response) =>
...
export async function getTodoList() {
  // return fetch("http://34.207.211.81:8000/todo").then((response) =>
...
export async function getHealth() {
  // return fetch("http://34.207.211.81:8000/health").then((response) =>
...
export async function addIncident(newIncident) {
  ...
  // return fetch("http://34.207.211.81:8000/incident", {
...
export async function updateTenantProfile(currentProfile) {
  ...
  // return fetch("http://34.207.211.81:8000/tenants", {
...
export async function updateHealth(currentHealth) {
  ...
  // return fetch("http://34.207.211.81:8000/health", {
...
export async function deleteProfile(currentProfile) {
  ...
  console.log("profileData")
  console.log(profileData)
  // return fetch("http://34.207.211.81:8000/tenants/delete", {
